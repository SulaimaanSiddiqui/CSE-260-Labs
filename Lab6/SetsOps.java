...
public class SetsOps {
	...
	/**
	 * Set1: [Blake, George, John, Jim, Kevin, Michael]
	 * Set2: [George, Katie, Kevin, Michelle, Ryan]
	 * Union of sets: [Blake, George, George, Jim, Kevin, Michael, John, Katie, Kevin, Michelle, Ryan]
	 * Difference of sets: [Blake, Jim, John, Michael]
	 * Intersection of sets: [George, Kevin]
	 * 
	 */
